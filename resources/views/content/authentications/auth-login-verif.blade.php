                ...
                <div class="row">
                    <div class="card mb-12">
                        <div class="card-body">
                            ...
                            <form id="formAuthentication" class="mb-3 row" action="{{ url('/auth/updateUserBeforeLogin') }}"
                                method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" id="id" value="{{ $data->id }}">
                                <input type="hidden" name="google_id" id="google_id" value="{{ $data->google_id }}">
                                ...
                                <div class="mb-3 col-12 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ $data->name }}" placeholder="Enter your name" autofocus>
                                </div>
                                <div class="mb-3 col-12 col-md-6">
                                    <label for="email" class="form-label">Email</label>
                                    <input type="text" class="form-control" id="email" name="email"
                                        value="{{ $data->email }}" onchange="chekEmailAktif(this.value)"
                                    ...
                                    <select id="role_structure" name="role_structure" class="select3 form-select"
                                        ...
                                        @foreach ($role_structure as $r)
                                            <option value="{{ $r->rs_id }}">
                                                {{ $r->rs_name }}</option>
                                            <option value="{{ $r->rs_id }}"
                                                {{ $r->rs_id == $data->role_structure ? 'selected' : '' }}>
                                                {{ $r->rs_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3 col-12 col-md-6">
                                    ...
                                    <input type="text" id="kontak" name="kontak" class="form-control phone-mask"
                                        ...
                                        value="{{ $data->kontak }}" onchange="chekKontakAktif(this.value)" />
                                ...
                                <div class="mb-3 col-12 col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="alamat" placeholder="Jl hr**"
                                        value="{{ $data->alamat }}" name="alamat" aria-label="Jl hr**" />
                                </div>

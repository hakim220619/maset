                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('storage/images/bangunan/'.$detail_bangunan->foto_tampak_depan)  }}" alt="foto tampak depan" width="200"></td>
                        </tr>
                        <tr>
                            <th>Foto Tampak Sisi Kiri</th>
                            <td><img src="{{ asset('storage/images/bangunan/'.$detail_bangunan->foto_tampak_sisi_kiri)  }}" alt="foto tampak sisi kiri" width="200"></td>
                        </tr>
                        <tr>
                            <th>Foto Tampak Sisi Kanan</th>
                            <td><img src="{{ asset('storage/images/bangunan/'.$detail_bangunan->foto_tampak_sisi_kanan)  }}" alt="foto tampak sisi kanan" width="200"></td>
                        </tr>
                        <tr>
                            <th>Foto Lainnya</th>
                            <td><img src="{{ asset('storage/images/bangunan/'.$detail_bangunan->foto_lainnya)  }}" alt="foto tampak lainnya" width="200"></td>
                        </tr>
                        <tr>
                            <th>Jumlah Lantai</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    ...
                                    <li>Bobot Struktur Beton Bertulang : {{ $detail_bangunan->tse_bobot_struktur_beton_bertulng }}</li>
                                </ul>                                
                            </td>
                        </tr>
                        <tr>

  ...
  <div class="container mt-5">
    <div class="card">
        ...
        <div class="card-body">
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('storage/images/bangunan/'.$detail_tanah_kosong->foto_tampak_depan)  }}" alt="foto tampak depan" width="200"></td>
                        </tr>
                        <tr>
                            <th>Foto Tampak Sisi Kiri</th>
                            <td><img src="{{ asset('storage/images/bangunan/'.$detail_tanah_kosong->foto_tampak_sisi_kiri)  }}" alt="foto tampak sisi kiri" width="200"></td>
                        </tr>
                        <tr>
                            <th>Foto Tampak Sisi Kanan</th>
                            <td><img src="{{ asset('storage/images/bangunan/'.$detail_tanah_kosong->foto_tampak_sisi_kanan)  }}" alt="foto tampak sisi kanan" width="200"></td>
                        </tr>
                        <tr>
                            <th>Foto Lainnya</th>
                            <td><img src="{{ asset('storage/images/bangunan/'.$detail_tanah_kosong->foto_lainnya)  }}" alt="foto tampak lainnya" width="200"></td>
                        </tr>
                        <tr>
                            <th>Jumlah Lantai</th>
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li>Nomor/Nama Lantai (Area) : {{ $detail_tanah_kosong->lbf_no_or_nama_lantai }} </li>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    ...
                                    <li>Bobot Struktur Beton Bertulang : {{ $detail_tanah_kosong->tse_bobot_struktur_beton_bertulng }}</li>
                                </ul>                                
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li>Tipe Dinding Eksisting : {{ $detail_tanah_kosong->tipe_dinding_eksisting }} </li>
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <a href="{{ route('lihat_object') }}" class="btn btn-secondary">Kembali</a>
            </div>
        </div>
    </div>
</div>

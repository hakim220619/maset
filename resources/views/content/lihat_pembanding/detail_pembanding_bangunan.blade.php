                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('storage/images/pembanding_bangunan/'.$detail_pembanding_bangunan->foto_tampak_depan)  }}" alt="foto tampak depan" width="200"></td>
                        </tr>
                        <tr>
                            <th>Foto Tampak Sisi Kiri</th>
                            <td><img src="{{ asset('storage/images/pembanding_bangunan/'.$detail_pembanding_bangunan->foto_tampak_sisi_kiri)  }}" alt="foto tampak sisi kiri" width="200"></td>
                        </tr>
                        <tr>
                            <th>Foto Tampak Sisi Kanan</th>
                            <td><img src="{{ asset('storage/images/pembanding_bangunan/'.$detail_pembanding_bangunan->foto_tampak_sisi_kanan)  }}" alt="foto tampak sisi kanan" width="200"></td>
                        </tr>
                        <tr>
                            <th>Foto Lainnya</th>
                            <td><img src="{{ asset('storage/images/pembanding_bangunan/'.$detail_pembanding_bangunan->foto_lainnya)  }}" alt="foto tampak lainnya" width="200"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li>Syarat Pembiayaan Batasan dilakukan pelunasan pembayaran (Kelunakan) : {{ $detail_pembanding_bangunan->pep_pembiayaan }} </li>
                                    <li>Kondisi Penjualan Bebas Ikatan, Waktu Pemasaran yang Wajar atau Ketiadaan Kondisi Pemaksa : {{ $detail_pembanding_bangunan->pep_penjualan }}</li>
                                    <li>Pengeluaran yang dilakukan segera setelah pembelian Biaya yang harus segera dikeluarkan untuk mengembalikan objek ke fungsi atau peruntukan awal atau seharusnya : {{ $detail_pembanding_bangunan->pep_pengeluaran }}</li>
                                    <li>Kondisi Pasar Kondisi Ekonomi Saat Terjadi Transaksi atau terbentuknya harga penawaran (Menggunakan Indikator Waktu Penawaran / Transaksi) : {{ $detail_pembanding_bangunan->pep_pasar }}</li>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li>Nomor/Nama Lantai (Area) : {{ $detail_pembanding_bangunan->lbf_no_or_nama_lantai }} </li>
                                    <li>Faktor Pengali Luas : {{ $detail_pembanding_bangunan->lbf_faktor_pengali_luas }}</li>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    ...
                                    <li>Bobot Pondasi Batu Kali : {{ $detail_pembanding_bangunan->tpe_bobot_pondasi }}</li>
                                </ul>                                
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    ...
                                    <li>Bobot Struktur Beton Bertulang : {{ $detail_pembanding_bangunan->tse_bobot_struktur_beton_bertulng }}</li>
                                </ul>                                
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li>Tipe Dinding Eksisting : {{ $detail_pembanding_bangunan->tipe_dinding_eksisting }} </li>

...
$(function () {
      ...
      buttons: [
        ...
        },
        {
          ...
          attr: {
            ...
            'data-bs-target': '#openModalAddRoleAccess'
          }
        }
      ]
  ...
  // Delete Record
  $('.datatables-role-access tbody').on('click', '.delete-record', function () {
    var id = $(this).data('id');
    Swal.fire({
      title: 'Are you sure?',
      text: "You won't be able to revert Role Access!",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonText: 'Yes, delete Role Access!',
      customClass: {
      ...
      if (result.value) {
        $.ajax({
          type: 'GET',
          dataType: 'json',
          url: '/setting/deleteRoleAccessProses/' + id,

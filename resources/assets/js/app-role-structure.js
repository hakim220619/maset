...
$(function () {
  ...
  var dt_role_structure_table = $('.datatables-role-structure');

  // Users datatable
  if (dt_role_structure_table.length) {
    var dt_user = dt_role_structure_table.DataTable({
      ajax: '/setting/roleStructureList',
      columns: [
      ...
      buttons: [
        ...
        },
        {
          ...
          attr: {
            ...
            'data-bs-target': '#openModalAddRoleStructure'
          }
        }
      ]
  ...
  // Delete Record
  $('.datatables-role-structure tbody').on('click', '.delete-record', function () {
    var id = $(this).data('id');
    Swal.fire({
      title: 'Are you sure?',
      text: "You won't be able to revert Role Structure!",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonText: 'Yes, delete Role Structure!',
      customClass: {
      ...
      if (result.value) {
        $.ajax({
          type: 'GET',
          dataType: 'json',
          url: '/setting/deleteRoleStructureProses/' + id,
